...
import { uploadImageProcess } from "@/utils/firestore/imageStorageUtils";
...
export const ProfilePictureUploader: React.FC<PPProps> = ({ userDocId }) => {
  ...
  return (
    <>
      <h3 className="text-xl text-devready-green font-semibold">
        Upload Profile Picture
      </h3>

      <div className="flex flex-col items-center justify-center text-center border-2 aspect-square p-5 relative">
        {!showAvatar ? (
          <>
